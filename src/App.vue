  ...
  <div class="container">
    <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white">
      ...
      <div class="d-flex align-items-center flex-shrink-0 text-decoration-none inputfield2 col-12">
        ...
        <div class="textzoeken">Zoeken in gesprek</div>
      </div>
      <!-- Scrollarea + messages -->
      <div class="list-group list-group-flush border-bottom border-top scrollarea">
        <div class="list-group-item list-group-item-action py-3 lh-tight msg1" v-for="message in messages"
          :key="message">
          <!-- Username message -->
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      //Post method message to port:8000 haalt data op
      const submit = async () => {
